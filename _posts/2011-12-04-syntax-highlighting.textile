...
What I still don't get is that the background of the syntax blocks do not get the background of pygments. Maybe the @screen.css@ file is causing me trouble?
